...
int main(int argc, char **argv)
{
   ...
   * The handler will aslo be used for creating publishers and subscribers
   */
  ros::NodeHandle n;
  ...
  ros::Rate loop_rate(1); // Mesasages per second
  ...
  */
  while (ros::ok())
  {
    ...
    ROS_INFO("[Talker] I published %s\n", msg.data.c_str()); // Pring the content of the message to the terminal
